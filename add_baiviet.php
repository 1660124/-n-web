...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<?php 
			...
			if($_SERVER['REQUEST_METHOD']=='POST')
			{
				...
				if(empty($errors))
				{
					...
					//inser vao trong db
					$query="INSERT INTO tblbaiviet(danhmucbaiviet,title,tomtat,noidung,anh,anh_thumb,ngaydang,giodang,ordernum,status)
		...
		<form name="frmbaiviet" method="POST" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label>Thứ tự</label>
				<input type="text" name="ordernum" value="<?php if(isset($_POST['ordernum'])){ echo $_POST['ordernum'];} ?>" class="form-control">
			</div>
			<div class="form-group">
